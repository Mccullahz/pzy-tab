...
export default function Options() {
	return (
		<section className="grid h-full grid-cols-2 gap-4">
			...
			{/* start stop action */}
			{/* should be a toggle button that starts and stops the roast. for time being static. */}
			...
			{/* active profile */}
			{/* currently static, but will eventually pull the profile name and details from the backend. just dont have profile functionality built yet */}
